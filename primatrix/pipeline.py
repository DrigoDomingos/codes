...
for fold in  train_col:
    ...
    for filename in os.listdir("/home/rodrigo/datasience/projects/pri-matrixFac/nano_chimps/nano"):#train_subset:        
        if str(filename) in str(train_subset):
            string = str("/home/rodrigo/datasience/projects/pri-matrixFac/nano_chimps/nano/" + str(filename))
